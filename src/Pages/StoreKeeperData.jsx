                ...
                actionsContainer={<AddComponent component={
                    <div className="grid grid-cols-1 gap-1">
                        <ul className="grid grid-cols-1 gap-1 md:grid-cols-2 lg:grid-cols-3">
                            {/* <span className=" flex items-center justify-between border rounded-md max-w-[200px] pr-1 h-full">
                            <span className=" h-full items-center p-2 rounded-tl-md rounded-bl-md">
                                <FiSearch />
                            </span>
                            <input type="text" name="search" id="search" autoComplete="off" placeholder="search supplier" className=" py-1 focus:outline-none  w-full" onChange={handleSearch} />
      ...
      {sup.map(({companyName,_id}) => (
        <li key={_id}>{companyName}</li>
                          ...
                          <select autoComplete="off" required name="search supplier" id="search supplier" className="focus:outline-none p-2 border rounded-md w-full" onChange={handleSearch} >
                                {sup.map(({ companyName, _id }) => (
                                    <option value={_id} key={_id} >{companyName}</option>
                                ))}
                            </select>
                          </li>
                          {/* **** */}
                          <li className=" space-y-2">
                                    ...
                                    <select autoComplete="off" required name="mineralType" id="mineralType" className="focus:outline-none p-2 border rounded-md w-full" value={formval.mineralType || ''} onChange={handleEntry} >
                        ...
                        <ul className="list-none grid gap-4 items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            {admin.role === 'admin' ? (<>
                                <li className=" space-y-1">
                                    ...
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="companyName" id="companyName" value={formval.companyName || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Email</p>
                                    <input type="email" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="email" id="email" value={formval.email || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">TIN Number</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="TINNumber" id="TINNumber" value={formval.TINNumber || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Licence number</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="licenseNumber" id="licenseNumber" value={formval.licenseNumber || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Company representative</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="companyRepresentative" id="companyRepresentative" value={formval.companyRepresentative || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Representative ID number</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="representativeId" id="representativeId" value={formval.representativeId || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Representative phone nbr</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="representativePhoneNbr" id="representativePhoneNbr" value={formval.representativePhoneNbr || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                ...
                                <li className=" space-y-1">
                                    ...
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="grossQty" id="grossQty" value={formval.grossQty || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Weight out</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="netQty" id="netQty" value={formval.netQty || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                    <p className="pl-1">Mine tags Number</p>
                                    <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="mineTagsNbr" id="mineTagsNbr" value={formval.mineTagsNbr || ''} onChange={handleEntry} />
                                </li>
                                <li className=" space-y-1">
                                <span className=" flex gap-2 items-center">
                                <p>Beneficiary</p>
                            ...
                            {admin.role === 'admin' ? (
                                <>
                                    <li className=" space-y-1">
                                        ...
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="mineTags" id="mineTags" value={formval.mineTags || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
                                    <li className=" space-y-1">
                                        <p className="pl-1">Negociant Tags</p>
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="negociantTags" id="negociantTags" value={formval.negociantTags || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
                                    <li className=" space-y-1">
                                        <p className="pl-1">Shipment number</p>
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="shipmentnumber" id="shipmentnumber" value={formval.shipmentnumber || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
                                    <li className=" space-y-1">
                                        <p className="pl-1">Lot number</p>
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="lotnumber" id="lotnumber" value={formval.lotnumber || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
                                </>
                            ) : null}
                            {admin.role === 'admin' ? (
                                <>
                                    <li className=" space-y-1">
                                        ...
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="mineralgrade" id="mineralgrade" value={formval.mineralgrade || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
                                    <li className=" space-y-1">
                                        <p className="pl-1">Mineral price</p>
                                        <input type="text" required autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="mineralprice" id="mineralprice" value={formval.mineralprice || ''} onChange={handleEntry} />
                                    </li>
                                    {/* ***** */}
