...
import {useCreateEntryMutation, useGetAllSuppliersQuery} from "../../../states/apislice";
...
const MixedEntryForm = () => {
    ...
    return (
        <>
            <ActionsPagesContainer title={'Register mixed entry'}
                                           ...
                                           <ul className="list-none grid gap-4 items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                                       ...
                                                       <div ref={modalRef} className="w-fit h-fit relative ">
                                                           ...
                                                           >
                                                               ...
                                                               {isLoading ? <div
                                                                   ...
                                                                   <ImSpinner2
                                                                       className="h-[20px] w-[20px] animate-spin text-gray-500"/>
                                                                   <p className=" text-slate-400">Fetching
                                                                       suppliers...</p>
                                               ...
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="text" autoComplete="off"
                                                          ...
                                                          value={formval.companyName || ''} onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                                   <p className="pl-1">Email</p>
                                                   <input type="email" autoComplete="off"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="email" id="email" value={formval.email || ''}
                                               ...
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="text" autoComplete="off"
                                                          ...
                                                          value={formval.TINNumber || ''} onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="text" autoComplete="off"
                                                          ...
                                                          value={formval.licenseNumber || ''} onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                                   <p className="pl-1">Company representative</p>
                                                   <input type="text" autoComplete="off"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="companyRepresentative" id="companyRepresentative"
                                               ...
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="text" autoComplete="off"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="representativeId" id="representativeId"
                                               ...
                                               <li className=" space-y-1">
                                                   ...
                                                   <input autoComplete="off" disabled name="mineralType"
                                                          id="mineralType"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          value={formval.mineralType || ''} onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                                   <p className="pl-1">Date</p>
                                                   <DatePicker onChange={handleAddDate} id="supplyDate"
                                                               name="supplyDate"
                                                               className=" focus:outline-none p-2 border rounded-md w-full"/>
                                               </li>
                                               <li className=" space-y-1">
                                                   <p className="pl-1">Time</p>
                                                   <TimePicker onChange={handleAddTime} format={'HH:mm'} id="date"
                                                               name="date"
                                                               className=" focus:outline-none p-2 border rounded-md w-full"/>
                                               </li>
                                               ...
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="text" autoComplete="off"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="weightIn" id="weightIn" value={formval.weightIn || ''}
                                                          onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                                   ...
                                                   <input type="number" autoComplete="off"
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="numberOfTags" id="numberOfTags"
                                                          value={formval.numberOfTags || ''} onChange={handleEntry}/>
                                               </li>
                                               <li className=" space-y-1">
                                <span className=" flex gap-2 items-center">
                                    <p>Beneficiary</p>
                                    <span
                                        className={`border h-4 w-9 rounded-xl p-[0.5px] duration-200 transform ease-in-out flex ${checked ? ' justify-end bg-green-400' : ' justify-start bg-slate-400'}`}
                                        onClick={handleCheck}>
                                        <span className={` w-4 h- border bg-white rounded-full `}></span>
                                    </span>
                                </span>
                                                   <input type="text" autoComplete="off" disabled={checked}
                                                          className="focus:outline-none p-2 border rounded-md w-full"
                                                          name="beneficiary" id="beneficiary"
                                                          value={formval.beneficiary || ''} onChange={handleEntry}/>
                                               </li>
                                                   ...
                                                   <div className="col-span-1 space-y-3">
                                                       {coltanLotDetails.map((lot, index) => (
                                                           <div key={index} className="flex gap-2 items-center w-full">
                                                               ...
                                                               <input animate={{}} type="number" autoComplete="off"
                                                                      className="focus:outline-none p-2 border rounded-md w-full"
                                                                      name="weightOut" value={lot.weightOut || ''}
                                                                      onWheelCapture={e => {
                                                                          e.target.blur()
                                                                      }} onChange={e => handleLotEntry(index, e)}/>
                                                               <HiMinus onClick={() => handleLRemoveLot(index)}
                                                                        className={`${coltanLotDetails.length - 1 == 0 ? 'hidden' : ''}`}/>
                                                               <HiPlus onClick={handleAddLot}
                                                                       className={`${coltanLotDetails.length - 1 !== index ? 'hidden' : ''}`}/>
                                                           </div>
                                                       ))}
                                                   </div>
                                                       ...
                                                       {cassiteriteLotDetails.map((lot, index) => (
                                                           <div key={index} className="flex gap-2 items-center w-full">
                                                               ...
                                                               <input animate={{}} type="number" autoComplete="off"
                                                                      ...
                                                                      onChange={e => handleCassiteriteLotEntry(index, e)}/>
                                                               <HiMinus
                                                                   onClick={() => handleCassiteriteRemoveLot(index)}
                                                                   className={`${cassiteriteLotDetails.length - 1 == 0 ? 'hidden' : ''}`}/>
                                                               <HiPlus onClick={handleAddCassiteriteLot}
                                                                       className={`${cassiteriteLotDetails.length - 1 !== index ? 'hidden' : ''}`}/>
                                                           </div>
                                                       ))}
                                                   </div>
