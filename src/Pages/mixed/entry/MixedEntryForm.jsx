...
import { useGetAllSuppliersQuery, useCreateMixedEntryMutation } from "../../../states/apislice";
                                ...
                                <div className="col-span-1 space-y-3">
                                    {coltanLotDetails.map((lot, index) => (
                                        <div key={index} className="flex gap-2 items-center w-full">
                                            ...
                                            <input animate={{}} type="number" autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="weightOut" value={lot.weightOut || ''} onWheelCapture={e => { e.target.blur() }} onChange={e => handleLotEntry(index, e)} />
                            ...
                            <li className=" space-y-3 grid gap-4 items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 col-span-full ">
                                ...
                                <div className="col-span-1 space-y-3">
                                    {cassiteriteLotDetails.map((lot, index) => (
                                        <div key={index} className="flex gap-2 items-center w-full">
                                            <p className=" font-semibold">{lot.lotNumber}</p>
                                            <input animate={{}} type="number" autoComplete="off" className="focus:outline-none p-2 border rounded-md w-full" name="weightOut" value={lot.weightOut || ''} onWheelCapture={e => { e.target.blur() }} onChange={e => handleCassiteriteLotEntry(index, e)} />
