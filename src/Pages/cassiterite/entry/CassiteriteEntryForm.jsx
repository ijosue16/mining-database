...
import { useGetAllSuppliersQuery, useCreateCassiteriteEntryMutation } from "../../../states/apislice";
...
const CassiteriteEntryForm = () => {
    ...
    const [createCassiteriteEntry, { isLoading: isSending, isError: isFail, error: failError, isSuccess: isDone }] = useCreateCassiteriteEntryMutation()
    const [formval, setFormval] = useState({ weightIn: "", companyName: "", licenseNumber: "", TINNumber: '', email: '', supplierId: '', companyRepresentative: "", representativeId: "", representativePhoneNumber: "", supplyDate: "", time: "", numberOfTags: '', mineTags: '', negociantTags: '', mineralType: 'cassiterite', mineralgrade: '', mineralprice: '', shipmentnumber: '', beneficiary: '', isSupplierBeneficiary: false });
    ...
    return (
        <>
            <ActionsPagesContainer title={'Register cassiterite entry'}
