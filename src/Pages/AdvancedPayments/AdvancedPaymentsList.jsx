...
import { useGetAllAdvancePaymentsQuery } from "../../states/apislice";
...
const handleCancel=()=>{
setPaymentDetailsModal({companyName:"",beneficiary:"",nationalId:"",phoneNumber:"",email:"",paymentAmount:"",currency:"",paymentDate:"",consumed:"",remainingAmount:"",consumptionDetails:""});
